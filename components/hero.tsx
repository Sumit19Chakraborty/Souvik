      ...
      <div className='container mx-auto h-full'>
        <div className='flex flex-col items-center justify-between gap-10 xl:flex-row xl:pt-8'>
          ...
          <div className='text-center xl:text-left'>
            ...
            <div className='py-8'>
              <p>
              As an experienced stock trader Academy with 4 years in the financial markets, I have honed a disciplined and data-driven approach to trading. <br />My passion lies in analyzing market trends, identifying strategic opportunities, and making informed investment decisions that maximize returns while minimizing risk.
              </p>
            </div>
